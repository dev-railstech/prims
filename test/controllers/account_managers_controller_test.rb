...
class AccountManagersControllerTest < ActionController::TestCase
  ...
  test "should create account_manager" do
    assert_difference('AccountManager.count') do
      post :create, account_manager: { code: @account_manager.code, joining_date: @account_manager.joining_date, name: @account_manager.name }
    end
  ...
  test "should update account_manager" do
    patch :update, id: @account_manager, account_manager: { code: @account_manager.code, joining_date: @account_manager.joining_date, name: @account_manager.name }
    assert_redirected_to account_manager_path(assigns(:account_manager))
  end
